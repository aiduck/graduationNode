var projectSQL = {
    insert:'INSERT IGNORE INTO project(project_id,project_name,project_content,target,course_id,status,is_choose) VALUES ?', 

    queryLimit: `SELECT project_id, project_name, project_content, target, project.course_id, project.status, is_choose, course_name FROM project inner join course on project.course_id = course.course_id limit ?, ?`,
